...
%description
Node that enables connected ROS-based devices or robots to exchange ROS messages
via an MQTT broker using the MQTT protocol.
...
%changelog
* Fri Mar 22 2024 Lennart Reiher <lennart.reiher@rwth-aachen.de> - 2.2.1-1
